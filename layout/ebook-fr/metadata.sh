...
licence="Cette œuvre est sous licence Creative Commons Attribution-ShareAlike 4.0 International License."
pubDate=`date +%Y-%m`
language=fr
title="Le changement climatique expliqué aux grenouilles"
tags="climat, grenouilles, bd, cop21, changement climatique, creative commons"
description="Tout le monde en parle, mais vous n'avez pas vraiment compris le problème : au juste, qu'est-ce que c'est que ce fameux changement climatique ?
